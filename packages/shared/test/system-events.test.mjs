...
test('device screen and keyguard facts remain independent',()=>{
  ...
  const device={...event,appId:'',source:'device_event',metadata:{...metadata,deviceEvent:{action:'screen_off',keyguardLocked:false,screenInteractive:false}}};
