...
export const bundledSkills = catalog.map(skill=>({...skill,version:skill.id==='personal-insight'?'1.0.4':skill.id==='working-memory'?'1.0.0':skill.id==='memory-extraction'||skill.id==='memory-consolidation'?'2.0.0':skill.id==='coding-memory'?'4.0.0':SKILL_VERSION,
