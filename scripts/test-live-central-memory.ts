...
const config:Config={dataDir:join(out,'data'),dataKey:undefined,token:randomUUID()+randomUUID(),tokenPath:'unused',profile:'test',host:'127.0.0.1',port:0,maxStorageBytes:256*1024*1024,maxExportBytes:32*1024*1024,retentionDays:0,insightIntervalHours:0,allowedOrigins:[],model:env.MOTE_MODEL!,modelProvider:'deepseek',modelProtocol:'deepseek',modelBaseUrl:env.MOTE_MODEL_BASE_URL||'https://api.deepseek.com',apiKey:env.MOTE_MODEL_API_KEY!,allowUnauthenticatedLocal:false,modelReasoningEffort:'high',modelMaxTokens:8192,modelRequestTimeoutMs:300000,agentTimeoutMs:300000,embeddingModel:'',embeddingBaseUrl:'',embeddingApiKey:'',diagnosticsEnabled:true,logLevel:'silent'};
