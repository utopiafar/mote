...
test('connection probe uses the real Harness for generated search, evidence and cited final response', {timeout:45000}, async()=>{
  ...
  try {
    ...
    const tools=['activity','changes','context_index','devices','evidence','file_chunks','material_catalog','material_read','media_activity','memories','progress_update','read_file_evidence','read_image','search_context','segments','skill','source_history','source_items','sources','timeline'];
