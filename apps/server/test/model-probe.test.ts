...
test('connection probe uses the real Harness for generated search, evidence and cited final response', {timeout:45000}, async()=>{
  ...
  try {
    ...
    const tools=['activity','changes','devices','evidence','file_chunks','media_activity','memories','progress_update','read_file_evidence','search_context','skill','source_history','source_items','sources','timeline'];
