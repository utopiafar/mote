...
export function register(app:FastifyInstance,{credential,mediaAssets,perception,semanticSelection,store,workflows}:Pick<FeatureServices,"credential"|"mediaAssets"|"perception"|"semanticSelection"|"store"|"workflows">){
