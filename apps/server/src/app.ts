...
export async function buildApp(config:Config,dependencies?:{store?:Store;agent?:QueryAgent;connections?:Connections}) {
  ...
  return {app,store,sources,memories,indexer,agent,diagnostics,connections};
}
