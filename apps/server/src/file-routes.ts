...
export function registerFileRoutes(app:FastifyInstance,files:FileStore,processing:FileProcessing,authorize:(req:FastifyRequest,sourceId:string)=>void,device:(req:FastifyRequest)=>string|undefined,diagnostics?:ServerDiagnostics){
