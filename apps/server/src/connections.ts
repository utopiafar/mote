...
export class Connections {
  ...
  assertCollectorRoute(credential:ConnectionCredential,method:string,route:string){
    ...
    const permitted:Record<string,string[]>={'/api/file-sync/v1/head':['GET','HEAD'],'/api/file-sync/v1/capabilities':['GET','HEAD'],'/api/file-sync/v1/uploads':['POST'],'/api/file-sync/v1/uploads/:id':['GET','HEAD'],'/api/file-sync/v1/uploads/:id/parts/:part':['PUT'],'/api/file-sync/v1/uploads/:id/commit':['POST'],'/api/file-sync/v1/revisions':['PUT'],'/api/files':['GET','HEAD'],'/api/files/:id':['GET','HEAD'],'/api/files/:id/chunks':['GET','HEAD'],'/api/files/:id/content':['GET','HEAD'],'/api/files/:id/playback':['POST'],'/api/captures':['POST'],'/api/captures/batch':['POST'],'/api/capture-browser/reconcile':['POST'],'/api/capture-browser':['GET','HEAD'],'/api/capture-browser/albums':['GET','HEAD'],'/api/capture-browser/album-images':['GET','HEAD'],'/api/capture-browser/:id':['GET','HEAD'],'/api/capture-browser/:id/image':['GET','HEAD'],'/api/capture-browser/:id/ocr':['POST'],'/api/media-activity':['GET','HEAD'],'/api/notes':['POST'],'/api/devices/heartbeat':['POST'],'/api/sources':['GET','HEAD','POST'],'/api/sources/:id':['PATCH'],'/api/sources/:id/items':['GET','HEAD','PUT'],'/api/sources/:id/item':['GET','HEAD'],'/api/sources/:id/history':['GET','HEAD'],'/api/source-items':['GET','HEAD']};
