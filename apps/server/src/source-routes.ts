...
export function registerSourceRoutes(app:FastifyInstance,{store,sources,fileEvidence,evidenceReader,connections,credential,sourceOwner}:{store:Store;sources:SourceStore;fileEvidence:FileEvidenceRequests;evidenceReader:EvidenceReader;connections:Connections;credential:(request:FastifyRequest)=>ConnectionCredential|undefined;sourceOwner:(request:FastifyRequest,id:string)=>void}){
