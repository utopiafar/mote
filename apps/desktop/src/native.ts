...
export function runHelper(path: string, command: 'calendar-status' | 'notifications' | 'active' | 'activity' | 'device' | 'ocr' | 'power' | 'qr' | 'installed-apps', input?: Buffer, signal?: AbortSignal): Promise<unknown> {
