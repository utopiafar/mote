...
export function runHelper(path: string, command: 'ui-page' | 'calendar-status' | 'notifications' | 'active' | 'activity' | 'device' | 'ocr' | 'power' | 'qr' | 'installed-apps', input?: Buffer, signal?: AbortSignal): Promise<unknown> {
