...
export async function calendarHelper(path: string, command: 'calendar-permission' | 'calendar-list' | 'calendar-scan' | 'calendar-create' | 'calendar-change', input?: unknown, signal?: AbortSignal): Promise<unknown> {
